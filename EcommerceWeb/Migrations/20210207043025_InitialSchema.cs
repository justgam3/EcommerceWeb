    ...
    public partial class InitialSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberWishlist", x => new { x.MemberID, x.ProductID });
                    table.ForeignKey(
                        name: "FK_MemberWishlist_Member_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Member",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberWishlist_Product_ProductID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Message", x => new { x.MemberID, x.ProductID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartDetail", x => new { x.MemberID, x.VariantID });
                    table.ForeignKey(
                        name: "FK_CartDetail_Member_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Member",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartDetail_Variant_VariantID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberWishlist_ProductID",
